...
case $choice in
	...
	2)
		...
		;;
	3)
		/usr/bin/steam -silent -no-browser -offline -applaunch 440 -windowed -w 2560 -h 1440 +connect 46.174.48.183:27015 -novid -noborder -console +viewmodel_fov 130 >/dev/null 2>/dev/null &
		;;
	4)
		echo
		 /usr/bin/steam -silent -no-browser -offline -applaunch 440 -windowed -w 2560 -h 1440 +connect 176.57.142.80:27055 -novid -noborder -console +viewmodel_fov 130 >/dev/null 2>/dev/null &
		;;
	5)
		echo
		/usr/bin/steam -silent -no-browser -offline -applaunch 440 -windowed -w 2560 -h 1440 +connect 5.135.189.29:27015  -novid -noborder -console +viewmodel_fov 130 >/dev/null 2>/dev/null &
		;;
	*)
		echo 'ERR0R'
		break
